...
const SubjectOverviewGrid = memo(({ subjects, onSelect, selectedId, compact = false }: SubjectOverviewGridProps) => {
  return (
    <motion.div
          ...
          if (compact) {
            return (
              <motion.button
                ...
                className={`
                  p-2.5 rounded-xl border transition-all text-center flex flex-col items-center gap-1.5
                  ${isSelected
              ...
              >
                ...
                <span className="text-[11px] font-semibold text-foreground leading-tight line-clamp-2">{subject.subjectName}</span>
